...
import { beraknaTraktamente, type DagDel } from '@/lib/traktamente';
...
export async function skapaTraktamentepost(formData: FormData) {
  ...
  await supabase.from('traktamente_poster').insert({
        ...
        maltider_lunch: m_lunch,
        maltider_middag: m_middag,
        belopp_heldag: r.belopp.heldag,
        belopp_halvdag: r.belopp.halvdag,
        belopp_natt: r.belopp.natt,
        avdrag_frukost: r.belopp.avdrag_frukost,
        avdrag_lunch: r.belopp.avdrag_lunch,
        avdrag_middag: r.belopp.avdrag_middag,
