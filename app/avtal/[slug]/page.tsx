  ...
  return (
    <div className="max-w-2xl mx-auto bg-white border border-line-soft rounded-sm p-10 sm:p-14">
      <div className="text-center mb-10 pb-8 border-b border-line">
        ...
        <div className="eyebrow mb-2">{detaljer.typ_label || 'Fotograferingsavtal'}</div>
      ...
      <div className="mb-8">
        <div className="eyebrow mb-4">{detaljer.typ ? 'Parter' : 'Detaljer'}</div>
        <dl className="grid grid-cols-2 gap-y-3 gap-x-6 text-sm">
          <div>
            <dt className="text-[11px] uppercase tracking-wider text-ink-muted mb-0.5">{detaljer.typ === 'foretag' ? 'Företag' : detaljer.typ ? 'Avbildad' : 'Kund'}</dt>
